...
from arxiv.browse.domain.license import ASSUMED_LICENSE_URI
...
class TestLicense(TestCase):
    def test_new_license(self):
        ...
        self.assertEqual(lic.effective_uri, r_uri)

        lic = License(None)
        self.assertNotEqual(lic, None)
        self.assertEqual(lic.recorded_uri, None)
        self.assertEqual(lic.effective_uri, ASSUMED_LICENSE_URI)
