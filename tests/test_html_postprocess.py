...
def test_post_process_html(app_with_test_fs):
    ...
    with app_with_test_fs.test_request_context():
        ...
        assert b"""[<a href="/pdf/0705.0001.pdf" title="Download PDF" id="pdf-0705.0001" aria-labelledby="pdf-0705.0001">pdf</a>, <a href="/ps/0705.0001" title="Download PostScript" id="ps-0705.0001" aria-labelledby="ps-0705.0001">ps</a>, <a href="/format/0705.0001" title="Other formats" id="oth-0705.0001" aria-labelledby="oth-0705.0001">other</a>]\n""" \
               in pphtml