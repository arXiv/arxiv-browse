(function () {
  ...
  var icons = {
    catalyzex: '<svg xmlns="https://www.catalyzex.com/assets/catalyzeX_logo-a747b368790c2d01e4abeb52322805149ea41b122784ace0770e896486aa9889.svg" class="pwc-icon pwc-icon-primary" viewBox="0 0 612 512" > <image href="https://www.catalyzex.com/assets/catalyzeX_logo-a747b368790c2d01e4abeb52322805149ea41b122784ace0770e896486aa9889.svg"></image> </svg>',
  ...
  const fetchcode = async () => {
    const response = await fetch('https://www.catalyzex.com/api/code?' + new URLSearchParams({
      'extension': 'true',
  ...
  async function renderCode ($output, data) {
    const catalyzexCode = await fetchcode();
    $output.html('');
    if (data === null) {
