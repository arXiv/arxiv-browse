...
from browse.services.database.listings import get_yearly_article_counts, get_articles_for_month
...
class HybridListingService(FsListingFilesService):
    ...
    def list_articles_by_month(self,
        ...
        return get_articles_for_month(archiveOrCategory, year, month, skip,show) # type: ignore