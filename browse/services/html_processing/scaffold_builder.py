...
def scaffold_metadata_from_published(abs_meta : DocMetadata, version: VersionEntry) -> ArticleScaffoldMetadata:
    ...
    date_of_version = version.submitted_date
    ...
    return ArticleScaffoldMetadata(
        license=license_str,
        page_id=f"{abs_meta.arxiv_id}v{version.version}",
